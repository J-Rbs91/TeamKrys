...
check("Version : application et cache annoncent ensemble la 1.12.1", () => {
  assert(config.includes('APP_VERSION: "1.12.1"'), "APP_VERSION non alignée");
  assert(sw.includes('CACHE_VERSION = "brainsto-v1.12.1"'), "CACHE_VERSION non alignée");
});
